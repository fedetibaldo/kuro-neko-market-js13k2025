...
import { BOTTOM, TOP, Vector, ZERO } from "../../core/vector";
import { GLYPH_PERCENT, GLYPH_SLASH } from "../../data/glyphs";
...
export class Results extends GameObject {
	...
	constructor() {
		...
		this.fishes = spawnedFish.map(([type]) => {
